...
def FP_FN_NF_MIMIC(df, diseases, category, category_name, seed=19, fpr_npr_path="default"):
...
def FP_NF_MIMIC_Two_Group_Inter(df, diseases, category1, category_name1, category2, category_name2, seed=19, fpr_npr_path_2_group_intersection="default"):
...
def FP_NF_MIMIC_Three_Group_Inter(df, diseases, category1, category_name1, category2,
                                  category_name2, category3, category_name3, seed=19, three_group_intersection_path="default"):
...
def main():
    ...
    for seed in seeds:
        ...
        for i in range(len(factor)):
            FP_FN_NF_MIMIC(df, [str(diseases[13])], factor[i],
        ...
        FP_NF_MIMIC_Two_Group_Inter(
            df, [str(diseases[13])], gender, 'gender', race, 'race', seed, fpr_npr_path_2_group_intersection)
        FP_NF_MIMIC_Two_Group_Inter(df, [str(diseases[13])], gender, 'gender', age_decile,
                                    'age_decile', seed, fpr_npr_path_2_group_intersection)
        FP_NF_MIMIC_Two_Group_Inter(df, [str(diseases[13])], race, 'race', age_decile,
                                    'age_decile', seed, fpr_npr_path_2_group_intersection)
        FP_NF_MIMIC_Two_Group_Inter(df, [str(diseases[13])], insurance, 'insurance',
                                    age_decile, 'age_decile', seed, fpr_npr_path_2_group_intersection)
        FP_NF_MIMIC_Two_Group_Inter(df, [str(diseases[13])], insurance, 'insurance',
                                    race, 'race', seed, fpr_npr_path_2_group_intersection)
        FP_NF_MIMIC_Two_Group_Inter(df, [str(diseases[13])], gender, 'gender',
        ...
        FP_NF_MIMIC_Three_Group_Inter(df, [str(diseases[13])], gender, 'gender', age_decile,
                                      'age_decile', race, 'race', seed, fpr_npr_path_3_group_intersection)
        FP_NF_MIMIC_Three_Group_Inter(df, [str(diseases[13])], insurance, 'insurance', gender,
        ...
        FP_NF_MIMIC_Three_Group_Inter(df, [str(diseases[13])], insurance, 'insurance', age_decile,
                                      'age_decile', race, 'race', seed, fpr_npr_path_3_group_intersection)
