...
def get_Sex_FNR_Disparities(basepath, diseases, diseases_abbr, number_of_runs, significance_level,
    ...
    sex_fnr_disp_df.to_csv(basepath+"sex_fnr_disp.csv", index=False)

    # Plotting the results
    plot_Sex_FNR_GAPS(basepath, sex_fnr_disp_df, height,
                      font_size, rotation_degree)


def plot_Sex_FNR_GAPS(basepath, sex_fnr_disp_df,
                      height, font_size, rotation_degree):
    ...
    plt.ylabel("FNR SEX DISPARITY", fontsize=font_size,
               fontname='Times New Roman')
    plt.legend()
    plt.grid(True)
    plt.savefig(basepath+"FNR_Dis_SEX.pdf")
    plt.close()


def get_Age_FNR_Disparities(basepath, diseases, diseases_abbr, number_of_runs, significance_level,
                            height, font_size, rotation_degree):
    ...
    age_fnr_disp_df.to_csv(basepath+"age_fnr_disp.csv", index=False)

    # Plotting the results
    plot_age_FNR_GAPS(basepath, age_fnr_disp_df, height,
                      font_size, rotation_degree)
...
def plot_age_FNR_GAPS(basepath, age_fnr_disp_df, height, font_size, rotation_degree):
    ...
    plt.xticks(rotation=rotation_degree, fontsize=font_size,
               fontname='Times New Roman')
    plt.ylabel("FNR AGE DISPARITY", fontsize=font_size,
               fontname='Times New Roman')
    plt.yticks(fontsize=font_size, fontname='Times New Roman')
    plt.legend()
    plt.grid(True)
...
def get_Race_FNR_Disparities(basepath, diseases, diseases_abbr, number_of_runs, significance_level,
                             height, font_size, rotation_degree):

    seed_19_race = pd.read_csv(basepath +
                               "Run_seed19_FNR_GAP_race.csv", index_col=0)
    seed_31_race = pd.read_csv(basepath +
                               "Run_seed31_FNR_GAP_race.csv", index_col=0)
    seed_38_race = pd.read_csv(
        basepath + "Run_seed38_FNR_GAP_race.csv", index_col=0)
    seed_47_race = pd.read_csv(
        basepath + "Run_seed47_FNR_GAP_race.csv", index_col=0)
...
def plot_race_FNR_GAPS(basepath, race_fnr_disp_df, height, font_size, rotation_degree):
    ...
    plt.xticks(rotation=rotation_degree, fontsize=font_size,
               fontname='Times New Roman')
    plt.ylabel("FNR RACE DISPARITY", fontsize=font_size,
               fontname='Times New Roman')
    plt.yticks(fontsize=font_size, fontname='Times New Roman')
    plt.legend()
    plt.grid(True)
    plt.savefig(basepath+"FNR_Dis_RACE.pdf")
    plt.close()


def get_Insurance_FNR_Disparities(basepath, diseases, diseases_abbr, number_of_runs, significance_level,
                                  height, font_size, rotation_degree):
    seed_19_insurance = pd.read_csv(
        basepath+"Run_seed19_FNR_GAP_insurance.csv", index_col=0)
    seed_31_insurance = pd.read_csv(
        basepath+"Run_seed31_FNR_GAP_insurance.csv", index_col=0)
    seed_38_insurance = pd.read_csv(
        basepath+"Run_seed38_FNR_GAP_insurance.csv", index_col=0)
    seed_47_insurance = pd.read_csv(
        basepath+"Run_seed47_FNR_GAP_insurance.csv", index_col=0)
    seed_77_insurance = pd.read_csv(
        basepath+"Run_seed77_FNR_GAP_insurance.csv", index_col=0)
    ...
    insurance_fnr_disp_df.to_csv(
        basepath+"insurance_tpr_disp.csv", index=False)

    # Plotting the results
    plot_insurance_FNR_GAPS(basepath, insurance_fnr_disp_df, height,
                            font_size, rotation_degree)


def plot_insurance_FNR_GAPS(basepath, insurance_fnr_disp_df, height, font_size, rotation_degree):
    ...
    plt.xticks(rotation=rotation_degree, fontsize=font_size,
               fontname='Times New Roman')
    plt.ylabel("FNR INSURANCE DISPARITY", fontsize=font_size,
               fontname='Times New Roman')
    plt.yticks(fontsize=font_size, fontname='Times New Roman')
    plt.legend()
    plt.grid(True)
    plt.savefig(basepath+"FNR_Dis_INSURANCE.pdf")
    plt.close()
