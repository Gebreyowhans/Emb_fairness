...
def get_Sex_Auc_Disparities(basepath, diseases, diseases_abbr, number_of_runs, significance_level):
    ...
    d = {'diseases': diseases, 'diseases_abbr': diseases_abbr_list, 'Distance': distance_list,
         'Gap_M_mean': gap_male_mean_list, 'CI_M': ci_male_list,
         'Gap_F_mean': gap_femal_mean_list, 'CI_F': ci_female_list}

    sex_auc_disp_df = pd.DataFrame(d)
    sex_auc_disp_df = sex_auc_disp_df.sort_values(by='Distance')
...
def get_Age_Auc_Disparities(basepath, diseases, diseases_abbr, number_of_runs, significance_level):
    ...
    # get AUC GAPS for each disease subgroup
    ...
    d = {'diseases': diseases, 'diseases_abbr': diseases_abbr_list, 'Distance': distance_list,
         'Gap_40-60_mean': gap_40_mean_list, 'CI_40-60': ci_40_list,
         'Gap_60-80_mean': gap_60_mean_list, 'CI_60-80': ci_60_list,
         'Gap_20-40_mean': gap_20_mean_list, 'CI_20-40': ci_20_list,
         'Gap_80-_mean': gap_80_mean_list, 'CI_80-': ci_80_list,
         'Gap_0-20_mean': gap_0_mean_list, 'CI_0-20': ci_0_list
         }

    # Creating a DataFrame from the dictionary
    age_auc_disp_df = pd.DataFrame(d)
...
def get_Race_Auc_Disparities(basepath, diseases, diseases_abbr, number_of_runs, significance_level):
    ...
    d = {'diseases': diseases, 'diseases_abbr': diseases_abbr_list, 'Distance': distance_list,
         'Gap_W_mean': gap_white_mean_list, 'CI_W': ci_white_list,
         'Gap_B_mean': gap_black_mean_list, 'CI_B': ci_black_list,
         'Gap_H_mean': gap_hisp_mean_list, 'CI_H': ci_hisp_list,
         'Gap_Ot_mean': gap_other_mean_list, 'CI_Ot': ci_other_list,
         'Gap_As_mean': gap_asian_mean_list, 'CI_As': ci_asian_list,
         'Gap_Am_mean': gap_american_mean_list, 'CI_Am': ci_american_list
         }
    race_auc_disp_df = pd.DataFrame(d)
...
def get_Insurance_Auc_Disparities(basepath, diseases, diseases_abbr, number_of_runs, significance_level):
    ...
    d = {'diseases': diseases, 'diseases_abbr': diseases_abbr_list, 'Distance': distance_list,
         'Gap_C_mean': gap_medicare_mean_list, 'CI_C': ci_medicare_list,
         'Gap_O_mean': gap_other_mean_list, 'CI_O': ci_other_list,
         'Gap_A_mean': gap_medicaid_mean_list, 'CI_A': ci_medicaid_list
         }
    
    insurance_auc_disp_df = pd.DataFrame(d)
    insurance_auc_disp_df = insurance_auc_disp_df.sort_values(by='Distance')
    insurance_auc_disp_df.to_csv(
        basepath+"insurance_auc_disp.csv", index=False)