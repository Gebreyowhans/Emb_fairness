...
def main():
    ...
    from MIMIC_CXR_EMB.FPR_Disparities_MIMIC_CXR import get_Sex_FPR_Disparities, get_Age_FPR_Disparities, get_Race_FPR_Disparities, get_Insurance_FPR_Disparities
