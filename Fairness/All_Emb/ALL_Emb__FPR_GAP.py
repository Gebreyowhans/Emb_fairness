...
def main():
    ...
    get_Sex_FPR_Disparities(fnr_base_path, diseases, diseases_abbr,
                            number_of_runs, significance_level, height, font_size, rotation_degree)

    # FNR Disparities for RACE
    get_Race_FPR_Disparities(fnr_base_path, diseases, diseases_abbr,
                             number_of_runs, significance_level, height, font_size, rotation_degree)

    # FNR Disparities for AGE
    get_Age_FPR_Disparities(fnr_base_path, diseases, diseases_abbr,
                            number_of_runs, significance_level, height, font_size, rotation_degree)
